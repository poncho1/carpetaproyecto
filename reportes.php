...
<!DOCTYPE html>
 <head>
 <title>Reportes Ferreteria VICASA</title>
 </head>
<style>
...
$('#content').attr('src', 'reporteventa.php');
		
});
		
$('#buscar').on('click', function(){
			
$('#content').attr('src', 'crearreporte.php');
...
<nav>
 <ul class="menu">
   <li class="activo"><a href="#" id="nuevo">Reporte de ventas</a></li>
   <li><a href="#" id="buscar">Crear reporte</a></li>
